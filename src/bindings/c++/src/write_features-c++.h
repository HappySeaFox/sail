...
public:
    ...
    std::map<int, std::vector<int>> pixel_formats_mappings() const;
    int features() const;
...
private:
    ...
    write_features& with_pixel_formats_mappings(const std::map<int, std::vector<int>> &pixel_formats_mappings);
